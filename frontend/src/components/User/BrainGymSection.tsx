...
type Mode = 'trivia' | 'wikipedia' | 'books';
            ...
            <div className="relative overflow-hidden rounded-3xl border border-purple-500/20 bg-black/60 backdrop-blur-xl p-8 flex flex-col items-center text-center w-full max-w-2xl shadow-2xl min-h-[600px]">
                ...
                <div className="grid grid-cols-3 gap-2 w-full mb-6">
                    <button
                        ...
                        className={`py-2 px-3 rounded-lg font-semibold transition-all text-sm ${mode === 'trivia'
                            ? 'bg-purple-500/20 border-2 border-purple-500 text-purple-200'
                    ...
                    <button
                        ...
                        className={`py-2 px-3 rounded-lg font-semibold transition-all text-sm ${mode === 'wikipedia'
                            ? 'bg-purple-500/20 border-2 border-purple-500 text-purple-200'
                            : 'bg-white/5 border border-white/10 text-slate-400 hover:bg-white/10'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`py-2 px-3 rounded-lg font-semibold transition-all text-sm ${mode === 'books'
                            ? 'bg-purple-500/20 border-2 border-purple-500 text-purple-200'
                            : 'bg-white/5 border border-white/10 text-slate-400 hover:bg-white/10'
                            }`}
                    >
